...
public class Config {
    ...
    public void updateFromJSON(JSONObject json) {
        try {
            ...
            if (json.has("smallIcon")) smallIcon = json.getString("smallIcon");
            if (json.has("largeIcon")) largeIcon = json.getString("largeIcon");
            if (json.has("color")) color = json.getString("color");
            if (json.has("priority")) priority = json.getInt("priority");
            if (json.has("channelId")) channelId = json.getString("channelId");
            if (json.has("channelName")) channelName = json.getString("channelName");
            // Backward compatibility
            if (json.has("notificationTitle")) title = json.getString("notificationTitle");
            if (json.has("notificationText")) text = json.getString("notificationText");
            if (json.has("notificationIcon")) smallIcon = json.getString("notificationIcon");
            if (json.has("notificationLargeIcon")) largeIcon = json.getString("notificationLargeIcon");
            if (json.has("notificationColor")) color = json.getString("notificationColor");
            if (json.has("notificationPriority")) priority = json.getInt("notificationPriority");
            if (json.has("notificationChannelId")) channelId = json.getString("notificationChannelId");
            if (json.has("notificationChannelName")) channelName = json.getString("notificationChannelName");
    ...
    private void copyFrom(Config other) {
        ...
        this.smallIcon = other.smallIcon;
        this.largeIcon = other.largeIcon;
